...
abstract public class AbstractSmackInteroperabilityLayer {
    ...
    private static final Logger logger = Logger.getLogger(
            AbstractSmackInteroperabilityLayer.class.toString());
    ...
    public static AbstractSmackInteroperabilityLayer getInstance() 
    {
        if (interopLayerInstance == null) 
        {
            ...
            catch (IllegalAccessException e)
            {
                ...
                logger.severe("Your AbstractSmackInteroperabilityLayer " +
                        "implementation " +
     ...
     *                 used
     */
    abstract public DataPacketProvider.PacketExtensionProvider getExtensionProvider(
